...
namespace Chronicle.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260804062731_ExternalSourcesAndCredentialKinds")]
    partial class ExternalSourcesAndCredentialKinds
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Chronicle.Domain.Entities.Profile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("site_profile", null, t =>
                        {
                            t.HasCheckConstraint("ck_site_profile_singleton", "\"Id\" = '0195c0de-0000-7000-8000-000000000002'");
                        });
                });
