...
/// <summary>
/// Initial data for the Certifications feature — owns profile_certifications.
/// </summary>
/// <remarks>
...
/// </para>
/// <code>
/// if (await context.Certifications.AnyAsync(cancellationToken).ConfigureAwait(false))
/// {
///     return;
/// }
///
...
/// </remarks>
internal sealed class CertificationsSeeder : IFeatureSeeder
{
    public int Order => 70;
