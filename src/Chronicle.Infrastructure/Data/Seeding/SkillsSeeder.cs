...
/// <summary>
/// Initial data for the Skills feature — owns profile_skills.
/// </summary>
/// <remarks>
...
/// </para>
/// <code>
/// if (await context.Skills.AnyAsync(cancellationToken).ConfigureAwait(false))
/// {
///     return;
/// }
///
...
/// </remarks>
internal sealed class SkillsSeeder : IFeatureSeeder
{
    public int Order => 20;
